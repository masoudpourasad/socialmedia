...
import 'package:socialmedia/services/chat_service.dart';
...
class ConversationViewModel extends ChangeNotifier {
  ...
  pickImage({int? source, required context, required String chatId}) async {
    ...
    if (pickedFile != null) {
      ...
      if (croppedFile != null) {
        ...
        _showInSnackBar("Uploading image...", context);
  ...
  void _showInSnackBar(String value, context) {
