...
import 'package:socialmedia/components/chat_bubble.dart';
import 'package:socialmedia/models/enum/message_type.dart';
import 'package:socialmedia/models/message.dart';
import 'package:socialmedia/models/user.dart';
import 'package:socialmedia/pages/profile.dart';
import 'package:socialmedia/utils/firebase.dart';
import 'package:socialmedia/view_models/conversation/conversation_view_model.dart';
import 'package:socialmedia/view_models/user/user_view_model.dart';
...
class _ConversationState extends State<Conversation> {
  ...
  setTyping(typing) {
    ...
    viewModel.setUser();
    var user = viewModel.user; // Use the user obtained from the viewModel
